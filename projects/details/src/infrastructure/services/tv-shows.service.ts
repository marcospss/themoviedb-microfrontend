...
export class TvShowsService {
  ...
  discover({
    ...
    page = 1,
  }: ParamsUrl): Observable<TvResults> {
    return this.http
      .get<TvResults>(
  ...
  search({ query, page = 1 }: ParamsUrl): Observable<TvResults> {
    return this.http
      .get<TvResults>(
  ...
  details({ mediaId }: ParamsUrl): Observable<TvDetails> {
    return this.http
      .get<TvDetails>(
  ...
  recommendations({ mediaId, page = 1 }: ParamsUrl): Observable<TvResults> {
    return this.http
      .get<TvResults>(
  ...
  similar({ mediaId, page = 1 }: ParamsUrl): Observable<TvResults> {
    return this.http
      .get<TvResults>(
  ...
  onTheAir({ page = 1 }: ParamsUrl): Observable<TvResults> {
    return this.http
      .get<TvResults>(
  ...
  popular({ page = 1 }: ParamsUrl): Observable<TvResults> {
    return this.http
      .get<TvResults>(
  ...
  topRated({ page = 1 }: ParamsUrl): Observable<TvResults> {
    return this.http
      .get<TvResults>(
