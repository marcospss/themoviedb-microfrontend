...
const envDirectory = './projects/collections/src/infrastructure/environments';
...
writeFileUsingFS(
  './projects/collections/src/infrastructure/environments/environment.prod.ts',
  ''
);
writeFileUsingFS(
  './projects/collections/src/infrastructure/environments/environment.ts',
  ''
);
